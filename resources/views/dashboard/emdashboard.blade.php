                ...
                <div class="col-md-12">
                    <div class="welcome-box">
                        <div class="welcome-img">
                            <img src="{{ '/assets/images/1688971962.jpg' }}" alt="{{ Auth::user()->name }}">
                        </div>
                        ...
                        <section>
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <table class="table table-striped custom-table datatable"><tbody>
                                    @foreach($holidays as $holiday)
                                    <tr>
                                    <td><h4 class="holiday-title mb-0">{{$holiday->name_holiday}}</td>
                                    <td><h4 class="holiday-title mb-0">{{$holiday->date_holiday}}</h4></td>
                                    </tr>
                                    @endforeach
                                      </tbody></table>
                                </div>
